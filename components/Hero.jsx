      ...
      <div className='container mx-auto'>
        <div className='flex items-center justify-between'>
          ...
          <div className='w-full xl:max-w-[580px] md:h-[820px] flex flex-col justify-center items-start'>
            ...
            >Discover the joy of cycling with our premium collection of bikes. From sleek road bikes 
            to robust mountain bikes, we offer quality, style, and performance for every rider's adventure.
            </p>
            {/* btn group */}
